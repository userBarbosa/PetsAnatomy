...
public class PatientControl {
	...
	public void generatedTable() {
		...
		TableColumn<Patient, String> colBloodtype = new TableColumn<>("Tipo Sangu�neo");
		...
		TableColumn<Patient, String> colObs = new TableColumn<>("Observa��o");
		colObs.setCellValueFactory(new PropertyValueFactory<Patient, String>("obs"));

		TableColumn<Patient, String> colLastVisit = new TableColumn<>("�ltima Consulta");
