...
public class AppointmentControl {
	...
	public void listAll() {
		appointments.clear();
		appointments.addAll( service.findByDate() );
	}
    ...
    public void generatedTable() {
        ...
        colId.setCellValueFactory(new PropertyValueFactory<Appointment, ObjectId>("id"));
        ...
        table.getColumns().addAll(colId, colDate, colTime, colPatient, colOwner, colEmployee, colState, colFinancialState, colValue, colObs);
